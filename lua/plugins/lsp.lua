	...
	config = function()
		vim.api.nvim_create_autocmd("LspAttach", {
			...
			callback = function(event)
				...
				map("cgd", require("telescope.builtin").lsp_definitions, "[C]ode [G]oto [D]efinition")

				-- Find references for the word under your cursor.
				map("cgr", require("telescope.builtin").lsp_references, "[C]ode [G]oto [R]eferences")

				-- Jump to the implementation of the word under your cursor.
				--  Useful when your language has ways of declaring types without an actual implementation.
				map("cgI", require("telescope.builtin").lsp_implementations, "[C]ode [G]oto [I]mplementation")
				...
				map("cgD", vim.lsp.buf.declaration, "[C]ode [G]oto [D]eclaration")
